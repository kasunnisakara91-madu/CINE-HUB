        ...
        if (savedMsg && savedMsg.message) {
            ...
            if (sessionConfig.ENABLE_DELETED_ALERT !== 'false') {
                try {
                    ...
                    let alertMsg = `🛡️ *𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰-𝙼𝙳 ᴀɴᴛɪ-ᴅᴇʟᴇᴛᴇ ᴀʟᴇʀᴛ* 🛡️\n\n` +
...
async function connectMongoDB() {
    try {
        ...
        console.log(`
╔══════════════════════════════════════╗
║     💎  MADUSANKA-MD CONNECT 💎      ║
╠══════════════════════════════════════╣
║  ✅ MongoDB Connected Successfully   ║
║  ⚡ System Status : ONLINE           ║
║  💻 Bot Engine   : MADUSANKA-MD      ║
╚══════════════════════════════════════╝
`);
        await initialize();
...
case 'flow': {
    try {
        ...
        await socket.sendMessage(senderJid, {
            text: `💎 *MADUSANKA-MD NATIVE FLOWS TESTER* 💎\n\n` +
        ...
        await sendInteractiveMessage(socket, {
            jid: senderJid,
            header: "💎 MADUSANKA-MD NATIVE FLOWS TESTER 💎",
...
case 'flow_location': {
    try {
        await sendInteractiveMessage(socket, {
            ...
            footer: "MADUSANKA-MD Native Location",
            buttons: [
                {
                    type: 'entry_point',
...
case 'flow_survey': {
    try {
        await sendInteractiveMessage(socket, {
            ...
            text: "Madusanka-md ආරක්ෂාව සහ ක්‍රියාකාරිත්වය ගැන ඔබේ අදහස දක්වන්න:",
            footer: "MADUSANKA-MD Survey",
            buttons: [
                {
                    type: 'entry_point',
                    text: 'Start Survey 📝',
...
case 'rename': {
    try {
        ...
        const DEFAULT_FOOTER = sessionConfig.BOT_FOOTER || config.BOT_FOOTER || '💎 MADUSANKA-MD BOT';
...
case 'owner': {
    try {
        ...
        const contactsArray = [
            {
                displayName: '𝗢𝗪𝗡𝗘𝗥',
                vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:🧚‍♂️ DAMITH MADUSANKA 🧚‍♂️\nTEL;type=CELL;type=VOICE;waid=94783731694:+94783731694\nEND:VCARD`
            }
        ];
    ...
    try {
        ...
        try {
            await socket.sendMessage(from, {
                ...
                mimetype: 'video/mp4',
                fileName,
                caption: `*📺 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝗟𝗔🇰𝗩𝗜𝗦𝗜𝗢𝗡 𝗩𝗜🇩🇪𝗢 📺*\n\n🎭 *Title:* ${videoInfo.title}\n\n${DEFAULT_FOOTER}`,
                jpegThumbnail
            }, { quoted: mm });
            sent = true;
        } catch (e1) {
...
case 'hanime':             
case 'hhentai': {
    const DEFAULT_FOOTER = `\n\n> 🔞 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝗛𝗔𝗡𝗜𝗠𝗘 𝗛𝗨𝗕 🔞\n> 🧬 ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝗧𝗘𝗖𝗛`;
    const from = sender;
...
case 'pinterest':
case 'pin': {
    const DEFAULT_FOOTER = `\n\n> 📌 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝗣𝗜𝗡𝗧𝗘𝗥𝗘𝗦𝗧 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗥 📌\n> 🧬 ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝗧𝗘𝗖𝗛`;
    const from = sender;
    const API_BASE = "https://chama-movie-api.koyeb.app";
    const API_KEY = "chama_api_2e93b415af83f521e819edf637005681";
                ...
                try {
                    ...
                    if (sessionConfig.WELCOME_SENT !== 'true') {
                        ...
                        const welcomeTemplate = sessionConfig.WELCOME_CONNECT_MSG || 
                            `🧚‍♂️ *MADUSANKA-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ* 🧚‍♂️\n\n` +
...
<head>
    ...
    <title>🧚‍♂️ MADUSANKA-MD — HELP CENTER</title>
